 ...
 *
 */
public class OptFrame2_0 extends JFrame{

	private static final long serialVersionUID = 1L;
	/**
	 * Attribute label type located in optframe2_0 module
	 */
	private JLabel label;
	/**
	 * Attribute button type located in optframe2_0 module
	 */
	private JButton yb;
	/**
	 * Attribute button type located in optframe2_0 module
	...
	public void startComp() {
		...
		label = new JLabel();
		label.setText("Remove contestant?");
