 ...
 *
 */
public class OptFrame3_2 extends JFrame{

	private static final long serialVersionUID = 1L;
	/**
	 * Attribute label type located in optframe3_2 module
	 */
	private JLabel label;
	/**
	 * Attribute button type located in optframe3_2 module
	 */
	private JButton okb;
	/**
	 * Constructor method
	...
	public void startComp() {
		...
		label = new JLabel();
		label.setText("Setted successful!");
